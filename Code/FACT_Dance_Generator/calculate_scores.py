...
def visualize(motion, smpl_model):
    ...
    # print("\nSmpl trans", smpl_trans,"  shape",smpl_trans.shape)
    ...
    # print("World:",world,"\n")
    # print("Keypoints: ",keypoints3d,"\n")

    print("Shape of final keypoints",keypoints3d.shape,"\n")
...
if __name__ == "__main__":
    ...
    # set smpl
    smpl = SMPL(model_path="/content/drive/MyDrive/Capstone_Project/mint-main/smpl/", gender='MALE', batch_size=1)

    # get motion features for the results
    result_features = {"kinetic": [], "manual": []}
    result_files = glob.glob("/content/drive/MyDrive/Capstone_Project/mint-main/outputs/*.npy")
    #result_files = glob.glob("/content/drive/MyDrive/Capstone_Project/mint-main/outputs/gBR_sBM_cAll_d05_mBR0_ch01_mJB5.npy")
    print("Result file is: ",result_files[0],"\n Type is : ",type(result_files[0]))
    # result_motion = np.load(result_files[0])[None, ...]  # [1, 120 + 1200, 225]
